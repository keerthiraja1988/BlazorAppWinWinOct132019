...
using WebApiClaimsA.Infrastructure;
using WebApiClaimsA.Repository;

namespace WebApiClaimsA
{
    public class Startup
    {
        ...
        public void ConfigureContainer(ContainerBuilder builder)
        {
            ...
            builder
                .Register(b => sqlConnection.AsParallel<IClaimsRepository>())
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "WebApi-ClaimsA", Version = "v1" });
            });
